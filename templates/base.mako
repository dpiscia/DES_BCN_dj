      ...
      <div class="navbar-inner">
        <div class="container ">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li ${'class= active' if (tab == 'home') else ''} ><a href="{% url 'registration.views.index'%} "> Home </a></li>
              <li ${'class= active' if (tab == 'program') else ''}><a href="">Program</a></li>
              <li ${'class= active' if (tab == 'participants') else ''}><a href="">Participants</a></li>
              <li ${'class= active' if (tab == 'venue_accommodation') else ''}><a href="">Venue & Accommodation</a></li>
              <li ${'class= active' if (tab == 'travel') else ''}><a href="">Travel</a></li>
              <li ${'class= active' if (tab == 'registration') else ''}><a href="{% url 'registration.views.registration'%}">Registration
</a></li>
              <li ${'class= active' if (tab == 'contact') else ''}><a href="">Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
